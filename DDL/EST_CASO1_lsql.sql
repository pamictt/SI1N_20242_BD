...
REFERENCES FORNECEDORES(FORNEC_COD) #REFERENCIA A PK DE FORNECEDORES
);

#CRIANDO A TABELA DE RECEBIMENTOS (DEPENDÊNCIA DE PEDIDOS)
...
#FASE 5: CRIANDO AS TABELAS ASSOCIATIVAS
