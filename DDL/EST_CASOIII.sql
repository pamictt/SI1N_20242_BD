...
ALTER TABLE EMPREGADOS ADD CNPJ_EMPRESA CHAR(14);
ALTER TABLE CLIENTES ADD COLUMN EMAIL VARCHAR(255) NOT NULL;
ALTER TABLE EMPREGADOS MODIFY SALARIO_EMPREGADOS DECIMAL(12, 2);
ALTER TABLE EMPRESAS CHANGE RAZAO_SOCIAL RAZAO_SOCIAL_EMPRESA VARCHAR(255) NOT NULL;
ALTER TABLE TIPOS_ENDERECO ADD CONSTRAINT UNIQUE (NOME);
ALTER TABLE TIPOS_COMPONENTE ADD COLUMN ATIVO TINYINT(1) DEFAULT 1;
